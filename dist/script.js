...
var changeModalState = function changeModalState(state) {
  ...
  function bindActionToElemems(event, elem, prop) {
  ...
  bindActionToElemems('click', windowFrom, 'form');
  bindActionToElemems('input', windowHeight, 'height');
  bindActionToElemems('input', windowWidth, 'width');
  bindActionToElemems('change', windowType, 'type');
  bindActionToElemems('change', windowProfile, 'profile');
};
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    close.addEventListener('click', function () {
      ...
      document.body.style.oveflow = ''; //document.body.classList.remove('modal-open')
    });
